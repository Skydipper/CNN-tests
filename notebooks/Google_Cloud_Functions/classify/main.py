...
def classify(request):
    ...
    # Request prediction
    response = predict_json(project="skydipper-196010", model=model_name, instances=instance, version=model_version)
    ...
    return json.dumps({'output': image.tolist()})